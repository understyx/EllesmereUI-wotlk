...
L["Prepend RBS::"] = "Prepend RBS:"
L["Prepend RBS:: to all lines of report chat. Disable to only prepend on the first line of a report"] = "Prepend RBS: to all lines of report chat. Disable to only prepend on the first line of a report"
